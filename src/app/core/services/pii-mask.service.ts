...
/**
 * Service for masking personally identifiable information (PII) to comply with POPIA regulations.
 * 
 * Provides methods to transform sensitive data patterns into safe representations for logging.
 * Supports email addresses, phone numbers, ID numbers, and credit card numbers.
 */
@Injectable({
  providedIn: 'root',
})
export class PiiMaskService {
  /**
